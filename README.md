...
Este repositório contém a API que alimenta o [app mobile](https://github.com/seu-usuario/raxa-mobile). Ela define o contrato oficial de dados, autenticação e regras de negócio do MVP.
